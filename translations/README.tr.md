...
> [Anthropic'in Claude'u](https://claude.ai) için en iyi kaynakların derlenmiş listesi — modeller, uygulamalar, Claude Code, Model Context Protocol, SDK'lar, araçlar ve öğrenme materyalleri.

[Claude](https://claude.ai), [Anthropic](https://www.anthropic.com) tarafından geliştirilen; yardımsever, dürüst ve zararsız olacak şekilde tasarlanmış bir yapay zeka modelleri ve ürünleri ailesidir. Bu liste, Claude'u *kullanmak* ve onunla *geliştirme yapmak* için yüksek değerli kaynakları bir araya getirir. Her şey elle seçilmiştir ve her bağlantı kontrol edilmiştir — ölü bağlantı yok, dolgu yok.
...
[Model Context Protocol](https://modelcontextprotocol.io), yapay zeka uygulamalarını harici araçlara ve verilere bağlamak için Anthropic tarafından oluşturulan açık bir standarttır.
...
- [github/github-mcp-server](https://github.com/github/github-mcp-server) — GitHub'ın depolar, issue'lar, PR'lar ve iş akışları için resmi MCP sunucusu.
...
> Birçok editör ve agent aynı zamanda birer MCP istemcisidir — [Yapay Zeka Kodlama Araçları](#yapay-zeka-kodlama-araçları) altındaki [Cursor](https://cursor.com), [Zed](https://zed.dev), [Cline](https://cline.bot), [Continue](https://continue.dev) ve [Goose](https://github.com/block/goose)'a bakın.
...
Katkılar memnuniyetle karşılanır — tek bir güzel bağlantı bile gayet iyi bir pull request'tir. Lütfen önce [katkı rehberini](../.github/CONTRIBUTING.md) okuyun. Kısaca: girdileri Claude'la ilgili, yüksek kaliteli, tekrarsız tutun ve `- [Ad](https://url) — kısa, olgusal açıklama.` biçiminde yazın.

Çeviri mi ekliyorsunuz? [Çeviriler](../.github/CONTRIBUTING.md#translations) bölümüne bakın.

## Lisans

[![CC0](https://licensebuttons.net/p/zero/1.0/88x31.png)](../LICENSE)

Yasaların izin verdiği ölçüde, katkıda bulunanlar bu esere ilişkin tüm telif ve komşu haklarından feragat etmiştir. Bkz. [LICENSE](../LICENSE) ([CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/)).
